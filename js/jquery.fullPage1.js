        ...
        */
        ...
        function scrolling(type, scrollable){
            ...
            if(type == 'down'){	
                ...
                if(hasMask1&&curPage==0){
	  		   		$('.page1_mask').animate({
			   			top:"-100%"
			   		},'slow',function(){
			    		$('.main-nav').animate({top:0},'slow',function(){
			    			hasMask1 = false;
			    			console.log(curPage,hasMask1)
			    		})
			    	})  
			    	
               }else if(hasMask2&&curPage==1){
 	  		   		$('.page2_mask').animate({
			   			top:"-100%"
			   		},'slow',function(){
